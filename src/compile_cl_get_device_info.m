...
opts = ["-R2018a" "-g" "COMPFLAGS='$COMPFLAGS -std=c++11 -O2'" "-LC /usr/lib/x86_64-linux-gnu" "-lOpenCL" fullfile(fpath,"cl_get_device_info.cpp") "-I"+fullfile(fpath,"..","sub","MatCL","src") "-outdir" fpath];
opts = cellstr(opts);
mex(opts{:});
